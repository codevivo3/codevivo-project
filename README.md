...
>>>>>>> a5b0f3b (Initial commit from Create Next App)
=======
>>>>>>> 5792bcc (feat: add NavBar component and global styles for CodeVivo portfolio)
...
- Multilingual (en / it) powered by `next-intl`
...
See the [deployment docs](https://nextjs.org/docs/app/building-your-application/deploying) for more info.