 ...
 */
=======
 * Renders the transactional email template used for inbound contact form messages.
 *
 * Context:
 * Generated by the contact server action before messages are sent through Resend.
 *
 * Notes:
 * This template is optimized for email clients, so styling stays inline and self-contained.
 */
