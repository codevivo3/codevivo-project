      ...
      <div className='mx-auto relative grid w-full max-w-5xl grid-cols-1 md:grid-cols-3 items-center gap-6 px-4 py-6 text-center text-xs text-fg/70 sm:px-6 md:text-left'>
        ...
        <div className="flex flex-col items-center md:items-end gap-5">
          ...
          >
            ...
            <span className="font-mono-var text-xs sm:text-sm">Schedule a call</span>
          </Link>
          ...
          >
            ...
            <span className="font-mono-var text-xs sm:text-sm">View my GitHub</span>
          </Link>
          ...
          >
            ...
            <span className="font-mono-var text-xs sm:text-sm">Connect on LinkedIn</span>
          </Link>
          ...
          >
            ...
            <span className="font-mono-var text-xs sm:text-sm">See my designs</span>
          </Link>
        </div>
      </div>
    </footer>
